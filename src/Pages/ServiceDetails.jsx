 ...
 <div className="min-h-screen flex justify-center items-center p-6">
    <div className="max-w-6xl w-full bg-white shadow-2xl rounded-2xl p-10 flex flex-col lg:flex-row gap-10">
      ...
      <div className="lg:w-1/2 space-y-4">
        ...
        <p><span className="font-semibold">Category:</span> {findResult?.category}</p>
        <p><span className="font-semibold">Provider:</span> {findResult?.provider}</p>
        <p><span className="font-semibold">Email:</span> {findResult?.email}</p>

        <p className="flex items-center gap-2">
          <span className="font-semibold">Rating:</span> ⭐ {findResult?.rating}
        </p>

        <p><span className="font-semibold">Slots Available:</span> {findResult?.slots}</p>
